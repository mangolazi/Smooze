#############################################################################
# Makefile for building: Smooze
# Generated by qmake (2.01a) (Qt 4.7.4) on: Sat Dec 28 14:39:55 2013
# Project:  Smooze.pro
# Template: app
# Command: c:\qtsdk\symbian\sdks\symbian3qt474\bin\qmake.exe -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc -o bld.inf Smooze.pro
#############################################################################
...
qmake:
	$(QMAKE) "C:/Qtapps/Smooze/Smooze.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

bld.inf: C:/Qtapps/Smooze/Smooze.pro
	$(QMAKE) "C:/Qtapps/Smooze/Smooze.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

c:\Qtapps\Smooze\Smooze.loc: 
	$(QMAKE) "C:/Qtapps/Smooze/Smooze.pro"  -spec ..\..\QtSDK\Symbian\SDKs\Symbian3Qt474\mkspecs\symbian-sbsv2 CONFIG+=release -after  OBJECTS_DIR=obj MOC_DIR=moc UI_DIR=ui RCC_DIR=rcc

debug: c:\Qtapps\Smooze\Smooze.loc bld.inf
...
release: c:\Qtapps\Smooze\Smooze.loc bld.inf
...
debug-winscw: c:\Qtapps\Smooze\Smooze.loc bld.inf
...
debug-gcce: c:\Qtapps\Smooze\Smooze.loc bld.inf
...
release-armv6-gcce4.4.1: c:\Qtapps\Smooze\Smooze.loc bld.inf
...
run:
	call C:/QtSDK/Symbian/SDKs/Symbian3Qt474/epoc32/release/winscw/udeb/Smooze.exe $(QT_RUN_OPTIONS)

runonphone: sis
	runonphone $(QT_RUN_ON_PHONE_OPTIONS) --sis Smooze.sis Smooze.exe $(QT_RUN_OPTIONS)

Smooze_template.pkg: C:/Qtapps/Smooze/Smooze.pro
	$(MAKE) -f $(MAKEFILE) qmake

Smooze_installer.pkg: C:/Qtapps/Smooze/Smooze.pro
	$(MAKE) -f $(MAKEFILE) qmake

Smooze_stub.pkg: C:/Qtapps/Smooze/Smooze.pro
	$(MAKE) -f $(MAKEFILE) qmake

sis: Smooze_template.pkg
...
ok_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) Smooze_template.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_sis: Smooze_template.pkg
...
ok_unsigned_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -g $(QT_SIS_OPTIONS) -o Smooze_template.pkg $(QT_SIS_TARGET)

Smooze.sis:
	$(MAKE) -f $(MAKEFILE) sis

installer_sis: Smooze_installer.pkg sis
	$(MAKE) -f $(MAKEFILE) ok_installer_sis

ok_installer_sis: Smooze_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) Smooze_installer.pkg - $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)

unsigned_installer_sis: Smooze_installer.pkg unsigned_sis
	$(MAKE) -f $(MAKEFILE) ok_unsigned_installer_sis

ok_unsigned_installer_sis: Smooze_installer.pkg
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat $(QT_SIS_OPTIONS) -o Smooze_installer.pkg

fail_sis_nocache:
	$(error Project has to be built or QT_SIS_TARGET environment variable has to be set before calling 'SIS' target)

stub_sis: Smooze_stub.pkg
...
ok_stub_sis:
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\createpackage.bat -s $(QT_SIS_OPTIONS) Smooze_stub.pkg $(QT_SIS_TARGET) $(QT_SIS_CERTIFICATE) $(QT_SIS_KEY) $(QT_SIS_PASSPHRASE)
...
compiler_moc_header_make_all: moc\moc_qmlapplicationviewer.cpp moc\moc_mediakeysobserver.cpp moc\moc_qdeclarativefolderlistmodel.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc\moc_qmlapplicationviewer.cpp moc\moc_mediakeysobserver.cpp moc\moc_qdeclarativefolderlistmodel.cpp
moc\moc_qmlapplicationviewer.cpp: qmlapplicationviewer\qmlapplicationviewer.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Qtapps\Smooze\qmlapplicationviewer\qmlapplicationviewer.h -o c:\Qtapps\Smooze\moc\moc_qmlapplicationviewer.cpp

moc\moc_mediakeysobserver.cpp: mediakeysobserver.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Qtapps\Smooze\mediakeysobserver.h -o c:\Qtapps\Smooze\moc\moc_mediakeysobserver.cpp

moc\moc_qdeclarativefolderlistmodel.cpp: qdeclarativefolderlistmodel.h
	C:\QtSDK\Symbian\SDKs\Symbian3Qt474\bin\moc.exe $(DEFINES) $(INCPATH) -DSYMBIAN c:\Qtapps\Smooze\qdeclarativefolderlistmodel.h -o c:\Qtapps\Smooze\moc\moc_qdeclarativefolderlistmodel.cpp
...
dodistclean:
	-@ if EXIST "c:\Qtapps\Smooze\Smooze_template.pkg" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze_template.pkg"
	-@ if EXIST "c:\Qtapps\Smooze\Smooze_stub.pkg" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze_stub.pkg"
	-@ if EXIST "c:\Qtapps\Smooze\Smooze_installer.pkg" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze_installer.pkg"
	-@ if EXIST "c:\Qtapps\Smooze\Makefile" $(DEL_FILE)  "c:\Qtapps\Smooze\Makefile"
	-@ if EXIST "c:\Qtapps\Smooze\Smooze_exe.mmp" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze_exe.mmp"
	-@ if EXIST "c:\Qtapps\Smooze\Smooze_reg.rss" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze_reg.rss"
	-@ if EXIST "c:\Qtapps\Smooze\Smooze.rss" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze.rss"
	-@ if EXIST "c:\Qtapps\Smooze\Smooze.loc" $(DEL_FILE)  "c:\Qtapps\Smooze\Smooze.loc"
	-@ if EXIST "c:\Qtapps\Smooze\bld.inf" $(DEL_FILE)  "c:\Qtapps\Smooze\bld.inf"
